 ...
 */
@Throws(Error::class)
public suspend fun HttpClient.postScriptCollectionDesigntimeArtifacts(
  input: ScriptCollectionDesigntimeArtifactCreate,
  X_CSRF_Token: String,
  builder: suspend HttpRequestBuilder.() -> Unit = {},
): PostScriptCollectionDesigntimeArtifacts? {
  ...
  if (response.status.isSuccess()) {
    val output = response.body<PostScriptCollectionDesigntimeArtifacts>()
    return output
  } else {
