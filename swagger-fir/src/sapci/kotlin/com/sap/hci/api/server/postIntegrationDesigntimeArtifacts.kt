 ...
 */
public fun Route.postIntegrationDesigntimeArtifacts(action: suspend ApplicationCall.(IntegrationDesigntimeArtifactCreate) -> PostIntegrationDesigntimeArtifacts) {
