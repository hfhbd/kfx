...
import com.sap.hci.api.PostScriptCollectionDesigntimeArtifacts
 ...
 */
public fun Route.postScriptCollectionDesigntimeArtifacts(action: suspend ApplicationCall.(ScriptCollectionDesigntimeArtifactCreate) -> PostScriptCollectionDesigntimeArtifacts) {
  route(path = """/ScriptCollectionDesigntimeArtifacts""") {
    contentType(Json) {
      accept(Json) {
        post {
          val body = call.receive<ScriptCollectionDesigntimeArtifactCreate>()
