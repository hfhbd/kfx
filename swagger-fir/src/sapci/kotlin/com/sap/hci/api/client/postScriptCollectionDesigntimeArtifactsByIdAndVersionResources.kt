 ...
 */
@Throws(Error::class)
public suspend fun HttpClient.postScriptCollectionDesigntimeArtifactsByIdAndVersionResources(
  input: ScriptCollectionDesigntimeArtifactResourceCreate,
  id: String,
  version: String = "active",
  X_CSRF_Token: String,
  builder: suspend HttpRequestBuilder.() -> Unit = {},
): PostScriptCollectionDesigntimeArtifactsByIdAndVersionResources? {
  ...
  if (response.status.isSuccess()) {
    val output = response.body<PostScriptCollectionDesigntimeArtifactsByIdAndVersionResources>()
    return output
  } else {
