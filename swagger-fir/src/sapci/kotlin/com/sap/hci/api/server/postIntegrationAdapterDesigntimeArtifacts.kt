 ...
 */
public fun Route.postIntegrationAdapterDesigntimeArtifacts(action: suspend ApplicationCall.(IntegrationAdapterDesigntimeArtifactImport) -> PostIntegrationAdapterDesigntimeArtifacts) {
