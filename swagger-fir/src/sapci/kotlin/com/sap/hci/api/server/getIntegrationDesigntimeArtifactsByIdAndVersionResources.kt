 ...
 */
public fun Route.getIntegrationDesigntimeArtifactsByIdAndVersionResources(action: suspend ApplicationCall.() -> GetIntegrationDesigntimeArtifactsByIdAndVersionResources) {
