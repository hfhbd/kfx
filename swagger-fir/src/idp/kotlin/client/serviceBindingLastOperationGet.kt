 ...
 */
public suspend fun HttpClient.serviceBindingLastOperationGet(
  ...
  val response = `get`(urlString = """v2/service_instances/${instance_id}/service_bindings/${binding_id}/last_operation""") {
