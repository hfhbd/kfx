...
import com.sap.hci.api.PutIntegrationDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndTypeReferencedResourceType
import com.sap.hci.api.PutIntegrationDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndTypeType
 ...
 */
@Throws(Error::class)
public suspend fun HttpClient.putIntegrationDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndType(
  input: ResourceUpdate,
  id: String,
  version: String = "active",
  name: String,
  type: PutIntegrationDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndTypeType,
  X_CSRF_Token: String,
  referencedResourceType: PutIntegrationDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndTypeReferencedResourceType? = null,
