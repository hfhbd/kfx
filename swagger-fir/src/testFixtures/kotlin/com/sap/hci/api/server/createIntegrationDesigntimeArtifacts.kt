 ...
 */
public fun Route.createIntegrationDesigntimeArtifacts(action: suspend ApplicationCall.(IntegrationDesigntimeArtifactCreate) -> CreateIntegrationDesigntimeArtifacts) {
  route(path = """/IntegrationDesigntimeArtifacts""") {
    contentType(Json) {
      post {
        val body = call.receive<IntegrationDesigntimeArtifactCreate>()
