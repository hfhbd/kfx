 ...
 */
@Throws(Error::class)
public suspend fun HttpClient.createMessageMappingDesigntimeArtifacts(
  input: ValueMappingDesigntimeArtifactCreate,
  X_CSRF_Token: String,
  builder: suspend HttpRequestBuilder.() -> Unit = {},
): CreateMessageMappingDesigntimeArtifacts? {
  ...
  if (response.status.isSuccess()) {
    return response.body<CreateMessageMappingDesigntimeArtifacts>()
  } else {
