 ...
 */
public fun Route.createScriptCollectionDesigntimeArtifacts(action: suspend ApplicationCall.(ScriptCollectionDesigntimeArtifactCreate) -> CreateScriptCollectionDesigntimeArtifacts) {
