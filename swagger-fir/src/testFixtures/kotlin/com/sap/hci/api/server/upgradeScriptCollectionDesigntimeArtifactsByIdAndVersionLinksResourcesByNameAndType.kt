 ...
 */
public fun Route.upgradeScriptCollectionDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndType(action: suspend ApplicationCall.(ResourceUpdate) -> Unit) {
