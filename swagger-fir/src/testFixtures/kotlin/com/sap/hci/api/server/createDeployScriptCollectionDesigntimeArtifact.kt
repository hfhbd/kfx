 ...
 */
public fun Route.createDeployScriptCollectionDesigntimeArtifact(action: suspend ApplicationCall.() -> Unit) {
  route(path = """/DeployScriptCollectionDesigntimeArtifact""") {
    contentType(Json) {
      post {
        call.action()
