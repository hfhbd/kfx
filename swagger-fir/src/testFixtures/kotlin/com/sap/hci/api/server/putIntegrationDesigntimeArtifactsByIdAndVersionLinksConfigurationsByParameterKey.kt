 ...
 */
public fun Route.putIntegrationDesigntimeArtifactsByIdAndVersionLinksConfigurationsByParameterKey(action: suspend ApplicationCall.(ConfigurationUpdate) -> Unit) {
