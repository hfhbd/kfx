...
import com.sap.hci.api.PostCopyIntegrationPackage
import com.sap.hci.api.PostCopyIntegrationPackageImportMode
 ...
 */
@Throws(Error::class)
public suspend fun HttpClient.postCopyIntegrationPackage(
  X_CSRF_Token: String,
  id: String? = null,
  importMode: PostCopyIntegrationPackageImportMode? = null,
  suffix: String? = null,
  builder: suspend HttpRequestBuilder.() -> Unit = {},
): PostCopyIntegrationPackage {
