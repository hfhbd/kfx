 ...
 */
public fun Route.postValueMappingDesigntimeArtifacts(action: suspend ApplicationCall.(ValueMappingDesigntimeArtifactCreate) -> PostValueMappingDesigntimeArtifacts) {
