...
import com.sap.hci.api.CreateIntegrationDesigntimeArtifacts
import com.sap.hci.api.IntegrationDesigntimeArtifactCreate
 ...
 */
@Throws(Error::class)
public suspend fun HttpClient.createIntegrationDesigntimeArtifacts(
  input: IntegrationDesigntimeArtifactCreate,
  X_CSRF_Token: String,
  builder: suspend HttpRequestBuilder.() -> Unit = {},
): CreateIntegrationDesigntimeArtifacts? {
  val response = post(urlString = """IntegrationDesigntimeArtifacts""") {
  ...
  if (response.status.isSuccess()) {
    return response.body<CreateIntegrationDesigntimeArtifacts>()
  } else {
