 ...
 * @param version Current version of message mapping to be updated <br>
 ...
 */
@Throws(Error::class)
public suspend fun HttpClient.upgradeMessageMappingDesigntimeArtifactsByIdAndVersion(
  input: MessageMappingDesigntimeArtifactUpdate,
  id: String,
