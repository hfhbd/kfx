 ...
 */
public fun Route.createValueMappingDesigntimeArtifactSaveAsVersion(action: suspend ApplicationCall.() -> Unit) {
  route(path = """/ValueMappingDesigntimeArtifactSaveAsVersion""") {
    contentType(Json) {
      post {
        call.action()
        call.respond(OK)
