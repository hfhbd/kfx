...
import com.sap.hci.api.PostValueMappingDesigntimeArtifacts
 ...
 */
@Throws(Error::class)
public suspend fun HttpClient.postValueMappingDesigntimeArtifacts(
  input: ValueMappingDesigntimeArtifactCreate,
  X_CSRF_Token: String,
  builder: suspend HttpRequestBuilder.() -> Unit = {},
): PostValueMappingDesigntimeArtifacts? {
  ...
  if (response.status.isSuccess()) {
    val output = response.body<PostValueMappingDesigntimeArtifacts>()
    return output
  } else {
