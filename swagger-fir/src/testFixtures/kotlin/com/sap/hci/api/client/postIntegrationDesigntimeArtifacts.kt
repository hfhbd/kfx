...
import com.sap.hci.api.PostIntegrationDesigntimeArtifacts
 ...
 */
@Throws(Error::class)
public suspend fun HttpClient.postIntegrationDesigntimeArtifacts(
  input: IntegrationDesigntimeArtifactCreate,
  X_CSRF_Token: String,
  builder: suspend HttpRequestBuilder.() -> Unit = {},
): PostIntegrationDesigntimeArtifacts? {
  ...
  if (response.status.isSuccess()) {
    val output = response.body<PostIntegrationDesigntimeArtifacts>()
    return output
  } else {
