 ...
 */
public fun Route.postMessageMappingDesigntimeArtifacts(action: suspend ApplicationCall.(ValueMappingDesigntimeArtifactCreate) -> PostMessageMappingDesigntimeArtifacts) {
