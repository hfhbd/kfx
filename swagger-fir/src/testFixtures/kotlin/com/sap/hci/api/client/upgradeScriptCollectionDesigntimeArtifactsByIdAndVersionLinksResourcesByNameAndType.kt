...
import com.sap.hci.api.UpgradeScriptCollectionDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndTypeReferencedResourceType
import com.sap.hci.api.UpgradeScriptCollectionDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndTypeType
 ...
 */
@Throws(Error::class)
public suspend fun HttpClient.upgradeScriptCollectionDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndType(
  input: ResourceUpdate,
  id: String,
  version: String = "active",
  name: String,
  type: UpgradeScriptCollectionDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndTypeType,
  X_CSRF_Token: String,
  referencedResourceType: UpgradeScriptCollectionDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndTypeReferencedResourceType? = null,
