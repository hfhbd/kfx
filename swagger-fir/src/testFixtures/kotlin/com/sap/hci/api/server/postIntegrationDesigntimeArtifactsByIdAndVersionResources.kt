 ...
 */
public fun Route.postIntegrationDesigntimeArtifactsByIdAndVersionResources(action: suspend ApplicationCall.(ResourceCreate) -> PostIntegrationDesigntimeArtifactsByIdAndVersionResources) {
