 ...
 */
public fun Route.createMessageMappingDesigntimeArtifactSaveAsVersion(action: suspend ApplicationCall.() -> Unit) {
  route(path = """/MessageMappingDesigntimeArtifactSaveAsVersion""") {
    contentType(Json) {
      post {
        call.action()
        call.respond(OK)
