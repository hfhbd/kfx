...
import com.sap.hci.api.UpgradeIntegrationDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndTypeReferencedResourceType
import com.sap.hci.api.UpgradeIntegrationDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndTypeType
 ...
 */
@Throws(Error::class)
public suspend fun HttpClient.upgradeIntegrationDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndType(
  input: ResourceUpdate,
  id: String,
  version: String = "active",
  name: String,
  type: UpgradeIntegrationDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndTypeType,
  X_CSRF_Token: String,
  referencedResourceType: UpgradeIntegrationDesigntimeArtifactsByIdAndVersionLinksResourcesByNameAndTypeReferencedResourceType? = null,
  builder: suspend HttpRequestBuilder.() -> Unit = {},
) {
  val response = put(urlString = """IntegrationDesigntimeArtifacts(Id='${id}',Version='${version}')/${'$'}links/Resources(Name='${name}',ResourceType='${type}')""") {
