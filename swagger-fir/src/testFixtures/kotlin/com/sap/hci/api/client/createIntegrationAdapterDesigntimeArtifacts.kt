 ...
 */
@Throws(Error::class)
public suspend fun HttpClient.createIntegrationAdapterDesigntimeArtifacts(
  input: IntegrationAdapterDesigntimeArtifactImport,
  X_CSRF_Token: String,
  builder: suspend HttpRequestBuilder.() -> Unit = {},
): CreateIntegrationAdapterDesigntimeArtifacts? {
  ...
  if (response.status.isSuccess()) {
    return response.body<CreateIntegrationAdapterDesigntimeArtifacts>()
  } else {
