...
import io.github.hfhbd.kfx.ir.IRTree.XmlType.Attribute
            ...
            IRTree(
                classes = setOf(
                    ...
                    NormalClass(
                        ...
                        namespace = "https://schema.gradle.org/dependency-verification",
                        members = mapOf(
                            "also-trust" to Member(
                                type = LIST(
                                    list = NormalClass(
                                        packageName = "org.gradle.schema.dependency_verification",
                                        packageNameSuffix = "",
                                        name = "AlsoTrust",
                                        serialName = "also-trustType",
                                        namespace = "https://schema.gradle.org/dependency-verification",
                                        members = emptyMap(),
                                        documentation = null,
                                        isFault = false,
                        ...
                        serialName = "verification-metadataType",
                        namespace = "https://schema.gradle.org/dependency-verification",
                        members = mapOf(
                            "configuration" to Member(
                                type = NormalClass(
                                    packageName = "org.gradle.schema.dependency_verification",
                                    packageNameSuffix = "",
                                    name = "Configuration",
