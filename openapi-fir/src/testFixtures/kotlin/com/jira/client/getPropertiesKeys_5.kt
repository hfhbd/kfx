 ...
 */
public suspend fun HttpClient.getPropertiesKeys_5(projectIdOrKey: String, builder: suspend HttpRequestBuilder.() -> Unit = {}): EntityPropertiesKeysBean? {
  val response = `get`(urlString = """api/2/project/${projectIdOrKey}/properties""") {
    builder()
  }
