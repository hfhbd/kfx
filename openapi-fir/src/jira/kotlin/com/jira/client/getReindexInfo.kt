 ...
 */
public suspend fun HttpClient.getReindexInfo(taskId: Long? = null, builder: suspend HttpRequestBuilder.() -> Unit = {}): ReindexBean? {
  val response = `get`(urlString = """api/2/reindex""") {
